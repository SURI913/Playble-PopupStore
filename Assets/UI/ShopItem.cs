...
public class ShopItem : MonoBehaviour
{
    ...
    IEnumerator SendRequest()
    {
        ...
        //없다면 string으로 false라는 문자열이 반환됩니다. 해당 값이 result에 담기게 됩니다.
        string url = "http://localhost:30001/check?itemname=" + "검사해야할itemname";
    ...
    public void StartWebView()
    {
        ...
        string minturl = "http://localhost:30001/mint?itemname=" + "NFT아이템이름(유저에게 보임)"
            + "&itemhash=" + "아이템해시값(Qm..)" + "유저ID번호";
